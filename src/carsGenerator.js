export default function carsGenerator(count) {
  const res = [
    ...
    {id:4, src: 'idImg_001', info:'arriere,escalier'},
    {id:5, src: 'idImg_002', info:'arrieve,pave,contour de piscine'},
    {id:6, src: 'idImg_000', info:'avant,escalier'},
    {id:7, src: 'idImg_001', info:'arriere,escalier'},
    {id:8, src: 'idImg_002', info:'arrieve,pave,contour de piscine'},
    {id:9, src: 'idImg_000', info:'avant,escalier'},
    {id:10, src: 'idImg_001', info:'arriere,escalier'},
    {id:12, src: 'idImg_002', info:'arrieve,pave,contour de piscine'},
    {id:11, src: 'idImg_000', info:'avant,escalier'},
    {id:12, src: 'idImg_001', info:'arriere,escalier'},
    {id:13, src: 'idImg_002', info:'arrieve,pave,contour de piscine'},
